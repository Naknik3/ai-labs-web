  ...
  return (
    <div className="legal">
      ...
      <div className="legal__doc">
        ...
        <p>
          AI LAB PRO is billed and managed entirely through the Apple App
          Store or Google Play — never by us directly. Your subscription
          is tied to the Apple ID or Google account you purchased it
          with, not to AI LAB's device token, so it will reappear
          automatically whenever that same account signs in through the
          store on a device.
        </p>
        <p>
          Because AI LAB has no login of its own, restoring your
          subscription won't bring back a lab's buildings or progress from
          another device — game state is tied to the device token
          described in our <a href="/privacy">Privacy Policy</a>, not to
          your store account. Restoring purchases only reconnects your
          AI LAB PRO entitlement.
        </p>

        <h2>iOS — restore in AI LAB</h2>
        <ul>
          <li>Open AI LAB and go to Settings.</li>
          <li>Tap AI LAB PRO, then tap "Restore Purchases."</li>
        ...
        <p>
          ...
          Subscriptions → select AI LAB PRO.
        </p>

        <h2>Android — restore in AI LAB</h2>
        <ul>
          <li>Open AI LAB and go to Settings.</li>
          <li>Tap AI LAB PRO, then tap "Restore Purchases."</li>
        ...
        <p>
          ...
          &amp; subscriptions → Subscriptions → select AI LAB PRO.
        </p>
        ...
        <p>
          ...
          <a href="mailto:guylhass@gmail.com?subject=Restore%20purchase%20issue%20-%20AI%20LAB">
            guylhass@gmail.com
          </a>{" "}
